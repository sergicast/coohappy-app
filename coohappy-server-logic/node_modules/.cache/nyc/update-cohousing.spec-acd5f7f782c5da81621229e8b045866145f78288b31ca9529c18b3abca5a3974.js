...
describe.only('logic - udpate-cohousing', () => {
    ...
    describe('sync errors', () => {
        ...
        it('on wrong type of address data', () => {
            let address2 = 'hola'
        await Cohousing.create({ name: nameCohousing, address: address2, author: userId, accessCode, members: [userId], laundryNum })
            expect(() => updateCohousing(userId, { name: newNameCohousing })).to.throw(`${dataToUpdate.address} is not an object`)
